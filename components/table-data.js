...
const TableComponent = ({ data }) => {
    const headerBgColor = useColorModeValue("gray.600", "gray.900"); // Darker background for header
        ...
        <Box overflowX="auto" p="4">
            <Table>
                <Thead bg={headerBgColor}>
                    <Tr>
                        <Th color={useColorModeValue("gray.100", "gray.100")} py="5">Currency Name</Th>
                        <Th color={useColorModeValue("gray.100", "gray.100")} py="5">Currency Symbol</Th>
                        <Th color={useColorModeValue("gray.100", "gray.100")} py="5" px="10">Currency Exchange Name</Th>
                    </Tr>
                </Thead>
                <Tbody>
                    {data.map((currency, index) => (
                        <Tr
                            ...
                            bg={index % 2 === 0 ? "gray.400" : "gray.300"} // Alternating row colors
                        >
                            <Td
                                borderTopWidth="4px"
                                px="16"
